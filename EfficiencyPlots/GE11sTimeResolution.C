...
void GE11sTimeResolution()
{
   ...
   //File3.open("EfficiencyData_R306_R407_Lat22_GE11_V.txt");
    ...
    File1.open("TR_2Gas.txt");
    File2.open("TR_3Gas_eta1.txt");
    File3.open("TR_3Gas_eta5.txt");
   ...
   const char* CanvasName   = "TimeResolution_wrt_EDrift";
   const char* pdfFile	    = "TimeResolution_wrt_EDrift.pdf";
   const char* pngFile	    = "TimeResolution_wrt_EDrift.png";
   TFile *f = new   TFile(    "TimeResolution_wrt_EDrift.root","RECREATE");
   ...
   gr1->GetXaxis()->SetTitle("E_{drift} (kV/cm)");
...
//   leg->AddEntry(gr9,Detector4,"PE");
   ...
   TLatex *text1 = new TLatex(2.80,19,"Threshold = 1.2 fC");
   TLatex *text2 = new TLatex(2.8,18,"Beam: Muon");
   TLatex *text3 = new TLatex(2.8,17,"Gap Config: 3/1/2/1 mm");
   TLatex *text4 = new TLatex(2.8,16,"Gas: Ar/CO2 (70/30)");
   TLatex *text5 = new TLatex(2.8,13,"Gas: Ar/CO2/CF4 (45/15/40)");
...
//   TLatex *text5 = new TLatex(3250,0.64,ClockMode);
   ...
   TLatex *cmsprem = new TLatex(2.1,20.2,"#it{CMS}");
   ...
   TLatex *gen = new TLatex(3.35,20.2,"GE1/1");
   //gen->SetTextFont(42);
