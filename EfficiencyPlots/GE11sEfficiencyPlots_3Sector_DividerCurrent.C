...
void GE11sEfficiencyPlots_3Sector_DividerCurrent()
{
   ...
   TF1 *f1 = new TF1("f1","[0]+(0.987)/([1]+exp(-[2]*(x-697.0)))",650,800);
   TF1 *f2 = new TF1("f2","[0]+(0.968)/([1]+exp(-[2]*(x-713)))",660,815);
   TF1 *f3 = new TF1("f3","[0]+(0.973)/([1]+exp(-[2]*(x-725)))",660,820);
   TF1 *f4 = new TF1("f4","[0]+(0.985)/([1]+exp(-[2]*(x-614)))",565,720);
