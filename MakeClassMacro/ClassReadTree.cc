...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxg1xcl = 10;

   static const Int_t kMaxg1ycl = 7;

   static const Int_t kMaxg2xcl = 11;

   static const Int_t kMaxg2ycl = 10;

   static const Int_t kMaxg3xcl = 12;

   static const Int_t kMaxg3ycl = 14;

   static const Int_t kMaxsCMSNS2LC1 = 9;

   static const Int_t kMaxsCMSNS2LC2 = 11;

   static const Int_t kMaxsCMSNS2LC2_R = 7;

   static const Int_t kMaxsCMSNS2LC2_L = 4;

   static const Int_t kMaxsCMSNS2LC3 = 12;
